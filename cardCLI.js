...
const basicCardBuilder = require('./basicCardBuilder.js');
const clozeCardBuilder = require('./clozeCardBuilder.js')
// const fs = require('fs');
...
function startCard() {
    inquirer.prompt(questions).then(function(answer) {
        ...
        if (fCardType === "Cloze card") {
            let clozeFlash = clozeCardBuilder(fCardType);

        } else {
            let basicFlash = basicCardBuilder(fCardType);
        }
    });
};
...
//             if (inputCheck) {
//             let newClozeCard = new ClozeCard(text, deletion); // creates new clozeCard object
